...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymatgen-analysis-diffusion-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymatgen-analysis-diffusion-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymatgen-analysis-diffusion
# for installing globally
pixi global install pymatgen-analysis-diffusion
```
...
It is possible to list all of the versions of `pymatgen-analysis-diffusion` available on your platform:
...
```
pixi search pymatgen-analysis-diffusion --channel conda-forge
```
